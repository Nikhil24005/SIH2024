! function(t, e) {
    ...
    function mt(t, e) {
        ...
        n && (function(t, e) {
            ...
            }(n, e.backdrop), !e.backdrop && e.allowOutsideClick && y('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
            function(t, e) {
        ...
        _main: function(t) {
            ...
            ! function(t) {
                for (var e in t)
                    ...
                    t.toast && (o = e, -1 !== It.indexOf(o) && y('The parameter "'.concat(o, '" is incompatible with toasts'))),
