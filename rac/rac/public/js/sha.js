...
(function(T) {
    ...
    function X(c, a, d) {
        ...
        for (g = 0; g < c.length; g += 4) {
            ...
            for (l = n = 0; l < h.length; l += 1)
                e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(h[l]),
                n |= e << 18 - 6 * l;
    ...
    function O(c, a) {
        ...
        for (f = 0; f < b; f += 3)
            for (g = f + 1 >>> 2,
                ...
                g = f + 2 >>> 2,
                g = c.length <= g ? 0 : c[g],
                g = (c[f >>> 2] >>> 8 * (3 - f % 4) & 255) << 16 | (e >>> 8 * (3 - (f + 1) % 4) & 255) << 8 | g >>> 8 * (3 - (f + 2) % 4) & 255,
                e = 0; 4 > e; e += 1)
                    ...
                    if ("UTF8" === a)
                        for (h = 0; h < c.length; h += 1)
                            for (b = c.charCodeAt(h),
                                l = [],
                                128 > b ? l.push(b) : 2048 > b ? (l.push(192 | b >>> 6),
                                    l.push(128 | b & 63)) : 55296 > b || 57344 <= b ? l.push(224 | b >>> 12, 128 | b >>> 6 & 63, 128 | b & 63) : (h += 1,
                                    b = 65536 + ((b & 1023) << 10 | c.charCodeAt(h) & 1023),
                                    l.push(240 | b >>> 18, 128 | b >>> 12 & 63, 128 | b >>> 6 & 63, 128 | b & 63)),
                                m = 0; m < l.length; m += 1) {
                                p = n + u;
    ...
    function z(c) {
        ...
        if ("SHA-1" === c)
            ...
            switch (a = [3238371032, 914150663, 812702999, 4144912697, 4290775857, 1750603025, 1694076839, 3204075428],
    ...
    function K(c, a) {
        ...
        l = a[4];
        for (h = 0; 80 > h; h += 1)
            d[h] = 16 > h ? c[h] : w(d[h - 3] ^ d[h - 8] ^ d[h - 14] ^ d[h - 16], 1),
    ...
    function L(c, a, d) {
        ...
        for (p = 0; p < r; p += 1)
            16 > p ? (u = p * v,
                ...
                A[p] = new H(m, u)) : A[p] = w(z(A[p - 2]), A[p - 7], y(A[p - 15]), A[p - 16]),
